...
Check the EPSG: is it indicated as *3414* now ?
...
![](images/clipboard-2365626806.png){fig-align="center" width="471"}

But on the other hands, most of the modelling packages in R is expecting a matrix. The rows represent **origins** (i.e. also know as **from** field) and the columns represent **destination** (i.e. also known as **to** field.)
...
![](images/clipboard-982812271.png){fig-align="center" width="347"}
...
Go to check the data frame. Notice that the field name is much more tidier now.

![](images/clipboard-3672038217.png){fig-align="center" width="440"}
...
![](images/clipboard-2356908137.png){fig-align="center" width="437"}
